...
{
    public partial class Controls_SpecialOffer : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                SpecialOffer offer = entity.GetFirst();
                //if (String.IsNullOrEmpty(strHeader))
                ltrHeader.Text = "<span style='color:#FFCF2A;text-decoration:underline;'>Сколько стоит дизайн-проект?</span> Рассчитайте<br>стоимость дизайн-проекта в 3-х вариантах!";
                //else
