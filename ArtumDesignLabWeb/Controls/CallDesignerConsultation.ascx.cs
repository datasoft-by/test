...
public partial class Controls_CallDesignerConsultation : System.Web.UI.UserControl
{
    ...
    protected void LinkButtonOrder_Click(object sender, EventArgs e)
    {
        ...
        foreach (string str in strReplies)
        {
            try
            {
                ...
                mail.Message.Subject = "С сайта artumstudio.ru заказана консультация дизайнера " + DesignerName + ".";
